...
export default function Clienttestimonials() {
  ...
  return (
    <div className="product-slider">
      ...
      <button className="postbtn" onClick={btnpressnext}>
        <p>&gt;</p>
      </button>
      <div className="product-container" ref={boxRef}>
        <Mycard
          testimonial="Before I tried TradingJournal, I wasn't sure if AI-powered stock trading apps were any good. But after using it, I've changed my mind. The app has two great features - the Trading Ledger and AI Insights - which have really helped me with my trading."
          personname="AKSHAY GUPTA"
        />
        <Mycard
          testimonial="TradingJournal is a great app for keeping me disciplined in my trading and helping me grow my investments. In trading, it's hard to stay steady and make choices based on facts instead of feelings. TradingJournal is really good at this. It helps me keep track of my trades and check how I'm doing, which keeps me focused on my plan and stops me from making quick, emotional decisions."
          personname=" NARENDER RAJU"
        />
        <Mycard
          testimonial="Trading Ledger has made trading stocks a breeze. Their Trading Ledger and AI Insights provide me with all the information I need to make informed decisions. I highly recommend Trading Ledger to any serious trader."
          personname="JAGANDEEP SINGH"
        />
